"Resource/UI/CharInfoArmorySubPanel.res"
{
	"armory_panel"
	{
		...
		"thumbnail_bgcolor"			"HUD_ButtonBg"
		"thumbnail_bgcolor_mouseover"	"HUD_ButtonBgHover"
		"thumbnail_bgcolor_selected"	"HUD_PrimaryColour"

		"thumbnails_rows"		"4"
		"thumbnails_columns"	"4"

		"thumbnails_x"			"c-309"	//(70 * 4) * (8 * 3) + 5
		"thumbnails_y"			"70"	//60
	...
	"DataPanel"
	{
		...
		"zpos"			"0"
		"wide"			"270"
		"tall"			"284"	//20 + 10 + ((50 * 4) + (8 * 3)) + 10 + 20
		"visible"		"1"
		"PaintBackgroundType"	"0"
		"paintborder"	"1"
		"border"		"HUD_PrimaryColourBorder"
